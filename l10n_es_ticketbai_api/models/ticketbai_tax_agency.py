...
class TicketBAITaxAgency(models.Model):
    ...
    def _compute_ticketbai_version(self):
        for record in self:
            ...
            record.rest_url_invoice = \
                tax_agency_version.rest_url_invoice
            record.rest_url_cancellation = \
                tax_agency_version.rest_url_cancellation
            record.test_rest_url_invoice = \
                tax_agency_version.test_rest_url_invoice
